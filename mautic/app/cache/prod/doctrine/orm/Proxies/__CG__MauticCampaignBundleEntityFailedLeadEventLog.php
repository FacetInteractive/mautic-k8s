...
class FailedLeadEventLog extends \Mautic\CampaignBundle\Entity\FailedLeadEventLog implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\FailedLeadEventLog' . "\0" . 'log', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\FailedLeadEventLog' . "\0" . 'dateAdded', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\FailedLeadEventLog' . "\0" . 'reason');
        }
