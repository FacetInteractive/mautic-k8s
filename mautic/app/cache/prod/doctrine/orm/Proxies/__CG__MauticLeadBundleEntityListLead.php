...
class ListLead extends \Mautic\LeadBundle\Entity\ListLead implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\ListLead' . "\0" . 'list', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\ListLead' . "\0" . 'lead', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\ListLead' . "\0" . 'dateAdded', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\ListLead' . "\0" . 'manuallyRemoved', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\ListLead' . "\0" . 'manuallyAdded');
        }
    ...
    public function setList($leadList)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setList', array($leadList));
