...
class PushID extends \Mautic\NotificationBundle\Entity\PushID implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\NotificationBundle\\Entity\\PushID' . "\0" . 'id', '' . "\0" . 'Mautic\\NotificationBundle\\Entity\\PushID' . "\0" . 'lead', '' . "\0" . 'Mautic\\NotificationBundle\\Entity\\PushID' . "\0" . 'pushID', '' . "\0" . 'Mautic\\NotificationBundle\\Entity\\PushID' . "\0" . 'enabled', '' . "\0" . 'Mautic\\NotificationBundle\\Entity\\PushID' . "\0" . 'mobile');
        }
